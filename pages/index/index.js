...
Page({
  data: {
    ...
    tab: [
      ...
      },
      {
        name: '不限',
        select: false,
        xuan: ['不限', '100以内', '100-300', '300-700', '700-1000', '1000以上']
      }
    ],
    list:[]
  ...
  loadGoods: function () {
    ...
    if (this.data.tab[2].name == '100以内') {
      query.lessThanOrEqualTo('price', 100);
    }
    if (this.data.tab[2].name == '100-300') {
      query.greaterThanOrEqualTo('price', 100);
      query.lessThanOrEqualTo('price', 300);
    }
    if (this.data.tab[2].name == '300-700') {
      query.greaterThanOrEqualTo('price', 300);
      query.lessThanOrEqualTo('price', 700);
    }
    if (this.data.tab[2].name == '700-1000') {
      query.greaterThanOrEqualTo('price', 700);
      query.lessThanOrEqualTo('price', 1000);
    }
    if (this.data.tab[2].name == '1000以上') {
