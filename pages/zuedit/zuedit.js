...
Page({
  ...
  upimg: function () {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        ctx.drawImage(res.tempFilePaths[0], 0, 0, 640, 480)
        ctx.draw()
  ...
  update: function (e) {
    ...
    query.find().then(function (goodsObject) {
      ...
      if (that.data.zujin == '') {
        ...
        av.set('zujin', "$" + that.data.zujin + "/week");
        av.set('price', parseInt(that.data.zujin));
      }

      if (that.data.tittz == '') {
        av.set('titt', '无标题');
      } else {
        av.set('titt', that.data.tittz);
      }
  ...
  upload: function (e) {
    ...
    var property = AV.Object('Property');
    if (this.data.tittz == '') {
    ...
    if (this.data.zujin == '') {
      property.set('zujin', "$" + 0 + "/week");
      property.set('price', 0);
    } else {
      property.set('zujin', "$" + this.data.zujin + "/week");
