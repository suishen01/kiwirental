...
Page({
  ...
  onShareAppMessage: function () {
    ...
    return {
      ...
      path: '/pages/det/det?id=' + that.data.id,
    }
  },
  like: function (){
    var that = this
  ...
  da: function () {
    ...
    wx.navigateTo({
      url: '../question/question?id=' + that.data.id + '&source=zu'
    })
  },
